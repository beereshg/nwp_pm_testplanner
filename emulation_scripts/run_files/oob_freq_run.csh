...
# oob_freq_run.csh
#
# HSD: 16030715609 - [PSS] Out of Boundary Frequency Check
#
# Launches HSLE IMH2 M7 (MCP ICI) emulation run to verify that PCode correctly
# clamps out-of-boundary frequency requests to the allowed min/max range.
#
# BIOS knobs required:
#   - ProcessorHWPMEnable = 1  (HWP enable -- required to write opc_hwp_controls)
#   - Run setup_bios_knobs.csh first if IFWI has not been prepared
#
# Script path on NFS (copy oob_freq_check.py there before running):
#   /nfs/site/disks/ive_dmr_prednv_009/mps/oob_freq_check.py
#
# Usage:
#   tcsh oob_freq_run.csh
# =============================================================================
...
crt -rid 40584 -bf mcp_ici_hsle_svos \
 ...
 -pythonsv.script /nfs/site/disks/ive_dmr_prednv_009/mps/oob_freq_check.py \
