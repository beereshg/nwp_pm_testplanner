#!/usr/intel/bin/tcsh
# =============================================================================
# tpmi_fabric_gv_run.csh
#
# HSD: 16030715607 - [PSS] TPMI-driven FabricGV
#
# Launches HSLE IMH2 M7 (MCP ICI) emulation run to verify that PCode responds
# to TPMI OPC HWP control writes by changing fabric GV ratios across all dies.
#
# BIOS knobs required:
#   - ProcessorHWPMEnable = 1
#   - Run setup_bios_knobs.csh first if IFWI has not been prepared
#
# Script path on NFS (copy tpmi_fabric_gv.py there before running):
#   /nfs/site/disks/ive_dmr_prednv_009/mps/tpmi_fabric_gv.py
#
# Usage:
#   tcsh tpmi_fabric_gv_run.csh
# =============================================================================
...
crt -rid 40584 -bf mcp_ici_hsle_svos \
 ...
 -pythonsv.script /nfs/site/disks/ive_dmr_prednv_009/mps/tpmi_fabric_gv.py \
