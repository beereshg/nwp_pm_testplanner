#!/usr/intel/bin/tcsh
# =============================================================================
# tpmi_imh_mem_run.csh
#
# HSD: 16030715619 - [PSS] TPMI register verification - IMH MEM
#
# Launches HSLE IMH2 M7 (MCP ICI) emulation run to verify IMH MEM TPMI registers.
# IMH MEM = imh1 in namednodes, imh9 in fuse/die naming.
#
# BIOS knobs required for this run:
#   - ProcessorHWPMEnable = 1  (HWP enable -- TPMI registers must be valid)
#   - Run setup_bios_knobs.csh first if IFWI has not been prepared
#
# Script path on NFS (copy tpmi_verify_imh_mem.py there before running):
#   /nfs/site/disks/ive_dmr_prednv_009/mps/tpmi_verify_imh_mem.py
#
# Usage:
#   tcsh tpmi_imh_mem_run.csh
# =============================================================================
...
crt -rid 40584 -bf mcp_ici_hsle_svos \
 ...
 -pythonsv.script /nfs/site/disks/ive_dmr_prednv_009/mps/tpmi_verify_imh_mem.py \
