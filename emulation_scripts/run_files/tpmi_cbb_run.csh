...
#
# Launches HSLE IMH2 M7 (MCP ICI) emulation run to verify CBB TPMI registers.
#
# BIOS knobs required for this run:
#   - ProcessorHWPMEnable = 1  (HWP enable -- TPMI HWP registers must be valid)
#   - Run setup_bios_knobs.csh first if IFWI has not been prepared
#
# Script path on NFS (copy tpmi_verify_cbb.py there before running):
#   /nfs/site/disks/ive_dmr_prednv_009/mps/tpmi_verify_cbb.py
#
# Usage:
#   tcsh tpmi_cbb_run.csh
# =============================================================================
...
crt -rid 40584 -bf mcp_ici_hsle_svos \
 ...
 -pythonsv.script /nfs/site/disks/ive_dmr_prednv_009/mps/tpmi_verify_cbb.py \
