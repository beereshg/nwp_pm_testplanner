#!/usr/intel/bin/tcsh
# =============================================================================
# dvfs_bios_config_run.csh
#
# HSD: 16030715600 - [PSS] BIOS Configurations of DVFS settings
#
# Launches HSLE IMH2 M7 (MCP ICI) emulation run to verify BIOS DVFS
# configuration in UFS TPMI registers across all dies.
#
# BIOS knobs required:
#   - ProcessorHWPMEnable = 1
#   - Run setup_bios_knobs.csh first if IFWI has not been prepared
#
# Script path on NFS (copy dvfs_bios_config.py there before running):
#   /nfs/site/disks/ive_dmr_prednv_009/mps/dvfs_bios_config.py
#
# Usage:
#   tcsh dvfs_bios_config_run.csh
# =============================================================================
...
crt -rid 40584 -bf mcp_ici_hsle_svos \
 ...
 -pythonsv.script /nfs/site/disks/ive_dmr_prednv_009/mps/dvfs_bios_config.py \
