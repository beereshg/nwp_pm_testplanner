...
| **Owner Team** | soc.pm |
| **Automation** | /usr/bin/solar/solar.sh /cfg /usr/lib/python3/dist-packages/diamondrapids/pm/Solar/SOLAR_DMR_XMLS/Exercise/CSTATES/Cstates_unsupported_Mwait_exercise.xml /logpath . /log_ip_disables |
...
| 2 | Run Solar: `/usr/bin/solar/solar.sh /cfg /usr/lib/python3/dist-packages/diamondrapids/pm/Solar/SOLAR_DMR_XMLS/Exercise/CSTATES/Cstates_unsupported_Mwait_exercise.xml /logpath . /log_ip_disables` | Solar exits with PASS; no timeout; no kernel panic. | Solar reports FAIL, hangs, or MCA during execution. |
