# Deep Analysis: CState Fast C1E: bios_knob C1E autopromotion_silicon
...
| **Segment** | FV |
| **TPF** | Fast C1E |
| **TCD** | CState Fast C1E: C1E autopromotion |
| **Status** | open |
| **Val Environment** | silicon,virtual_platform |
| **Owner Team** | soc.pm |
| **Automation** | flexconPM.xml |
...
- HSD TC: https://hsdes.intel.com/appstore/article-one/#/22022423091