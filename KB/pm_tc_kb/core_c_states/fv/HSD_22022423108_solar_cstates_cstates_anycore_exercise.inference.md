...
| **Owner Team** | soc.pm |
| **Automation** | /usr/bin/solar/solar.sh /cstate -scope 0:0:100 -states C1,C6  -mode e /logpath . /log_ip_disables |
...
| 2 | Run Solar: `/usr/bin/solar/solar.sh /cstate -scope 0:0:100 -states C1,C6  -mode e /logpath . /log_ip_disables` | Solar exits with PASS; no timeout; no kernel panic. | Solar reports FAIL, hangs, or MCA during execution. |
