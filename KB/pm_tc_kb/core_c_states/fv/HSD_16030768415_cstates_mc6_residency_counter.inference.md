# Deep Analysis: CStates MC6 residency counter

| Field | Value |
|-------|-------|
| **HSD ID** | 16030768415 |
| **Title** | CStates MC6 residency counter |
| **Date** | 2026-07-03 |
...
Verify C-state residency counters on NWP. When cores idle in MC6, hardware residency counters must increment proportionally to idle time. Correct counter behavior is critical for power management telemetry, OS power governor decisions, and RAPL energy accounting.
...
| 2 | Drive cores to idle in MC6 for N seconds (e.g. 10s). | Cores in {cs}; idle workload confirming no spurious wake. | Cores not entering {cs}; residency stays flat. |
...
- HSD TC: https://hsdes.intel.com/appstore/article-one/#/16030768415