# TC 22022421698: pmx Security x RACL
...
### Test Case Intent
for spec / bug references.

### Pre-Conditions
Item Requirement Feature pmx Security x RACL Platform NWP validation target (silicon or emulation) with PM integration features enabled.
