...
## Metadata
- HSD ID: 22022015466
- Title: CBB DTS Thermal Telemetry
- Feature: SoC Thermal
- Sub Feature: CBB DTS & Telemetry
- Script: pm/pss/thermal/pm_mcp_tm2_cbb.py
- HSD Script: (none)
- TC Owner: jinwengo
- TR Owner: mps
...
- Test Case: [22022015466 - CBB DTS Thermal Telemetry](https://hsdes.intel.com/appstore/article/#/22022015466)
- Test Result: [22022027536 - [PSS][TELEMETRY] CBB DTS Thermal Telemetry](https://hsdes.intel.com/appstore/article/#/22022027536)

## KB References
- KB Article: [KB/pm_features/soc_thermal/cbb_dts_telemetry.md](../../../KB/pm_features/soc_thermal/cbb_dts_telemetry.md)
