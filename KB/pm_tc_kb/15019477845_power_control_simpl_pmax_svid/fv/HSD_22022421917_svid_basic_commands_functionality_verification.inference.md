...
- [DMR SVID HAS](https://docs.intel.com/documents/pm_doc/src/server/dmr/pm_features/svid/svid.html) — SVID command set (GetVID, SetVID, SetPS, GetImon); timing requirements; SBE handling
