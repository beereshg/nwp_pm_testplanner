# HSD 22022422555: PKGC x UFS Max Freq

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422555](https://hsdes.intel.com/appstore/article/#/22022422555) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PKGC x UFS |
...
Verify PC6 behavior with UFS at max frequency including checkerboard patterns.
...
**Verify UFS traffic patterns do not interact with disabled PC6**
...
2. **Negative test**: Verify UFS traffic patterns do not interact with disabled PC6
