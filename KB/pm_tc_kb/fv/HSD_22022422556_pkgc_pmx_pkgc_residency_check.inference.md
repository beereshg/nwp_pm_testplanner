# HSD 22022422556: PMX_PkgC_Residency_Check

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422556](https://hsdes.intel.com/appstore/article/#/22022422556) |
| **Segment** | FV |
...
PMX focused test for PC6 residency validation across randomized PM features.
...
**Disposition: Modify (verify 0 residency)**
...
**Verify MSR 0x3F9 PC6 residency = 0 always regardless of idle depth**
...
1. **Disposition**: Modify (verify 0 residency)
2. **Negative test**: Verify MSR 0x3F9 PC6 residency = 0 always regardless of idle depth
