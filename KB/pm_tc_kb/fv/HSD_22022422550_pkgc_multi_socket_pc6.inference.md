# HSD 22022422550: Multi socket PC6

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422550](https://hsdes.intel.com/appstore/article/#/22022422550) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | HW/SW configs |
...
Verify multi-socket PC6 coordination across sockets.
...
**Verify no cross-socket PC6 coordination occurs. NWP is single-socket focused.**
...
2. **Negative test**: Verify no cross-socket PC6 coordination occurs. NWP is single-socket focused.
