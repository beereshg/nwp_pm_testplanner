# HSD 22022422489: PC6 MSRs

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422489](https://hsdes.intel.com/appstore/article/#/22022422489) |
| **Segment** | FV |
...
Verify MSRs controlling PC6: MSR 0xE2 PKG_C_STATE_LIMIT, MSR 0x3F9 PC6 residency counter.
...
**Verify MSR 0xE2 bit[10:9]=0 (PC6 blocked), MSR 0x3F9=0 always**
...
2. **Negative test**: Verify MSR 0xE2 bit[10:9]=0 (PC6 blocked), MSR 0x3F9=0 always
