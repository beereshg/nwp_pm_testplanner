# HSD 22022422502: Verify PkgC SAPMCTL_CFG knob

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422502](https://hsdes.intel.com/appstore/article/#/22022422502) |
| **Segment** | FV |
...
Verify SAPMCTL_CFG register controls PkgC entry/exit behavior.
...
**Verify SAPMCTL_CFG reflects disabled PC6 state - no SAPM actions for PC6**
...
2. **Negative test**: Verify SAPMCTL_CFG reflects disabled PC6 state - no SAPM actions for PC6
