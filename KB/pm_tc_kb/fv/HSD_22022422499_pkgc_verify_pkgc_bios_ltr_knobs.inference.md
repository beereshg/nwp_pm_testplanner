# HSD 22022422499: Verify PkgC BIOS LTR knobs

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422499](https://hsdes.intel.com/appstore/article/#/22022422499) |
| **Segment** | FV |
...
SOC has PCIe_LTR and SW_LTR BIOS settings for PkgC latency tolerance.
...
**Verify LTR knobs exist but PC6 path disabled - LTR does not enable PC6**
...
2. **Negative test**: Verify LTR knobs exist but PC6 path disabled - LTR does not enable PC6
