# HSD 22022422482: Ensure VccR is at Vmin

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422482](https://hsdes.intel.com/appstore/article/#/22022422482) |
| **Segment** | FV |
...
Verify VccR drops to idle fuse Vmin during PC6. FIVR output may be slightly different from fuse values.
...
**Verify VccR voltage behavior during MC6 without PC6 coordination**
...
2. **Negative test**: Verify VccR voltage behavior during MC6 without PC6 coordination
