# HSD 22022422593: PkgC x Surprise_Reset_silicon

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422593](https://hsdes.intel.com/appstore/article/#/22022422593) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x Reset |
...
Verify Surprise Reset handling during PC6 state.
...
**Verify Surprise Reset flow without PC6 dependency - reset from MC6**
...
2. **Negative test**: Verify Surprise Reset flow without PC6 dependency - reset from MC6
