# HSD 22022422613: Solar_silicon

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422613](https://hsdes.intel.com/appstore/article/#/22022422613) |
| **Segment** | FV |
...
Solar randomized test including PC6 scenarios. Self-checking test framework.
...
**Configure Solar to exclude PC6 scenarios on NWP - randomize MC6 and shallower states only**
...
1. **Disposition**: Modify (remove PC6)
2. **Negative test**: Configure Solar to exclude PC6 scenarios on NWP - randomize MC6 and shallower states only
