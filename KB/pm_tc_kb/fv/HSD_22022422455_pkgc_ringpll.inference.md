# HSD 22022422455: RINGPLL

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422455](https://hsdes.intel.com/appstore/article/#/22022422455) |
| **Segment** | FV |
...
Verify Ring PLL disabled during PC6 entry. Ring PLL gates when all modules idle and package enters PC6.
...
**Verify RINGPLL remains active during MC6 - no package-level ring gating without PC6**
...
2. **Negative test**: Verify RINGPLL remains active during MC6 - no package-level ring gating without PC6
