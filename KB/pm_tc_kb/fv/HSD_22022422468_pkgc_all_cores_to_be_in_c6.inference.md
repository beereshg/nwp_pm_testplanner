# HSD 22022422468: All Cores to be in C6

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422468](https://hsdes.intel.com/appstore/article/#/22022422468) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | Link/Fabric/Mem State |
...
IMH PrimeCode is unaware of Core C6 entries. PUnit informs PrimeCode of all_cores_in_c6 signal for fabric coordination.
...
**Verify all_cores_in_c6 signal during MC6 does not trigger PC6 fabric power-gating flow**
...
1. **Disposition**: Modify (MC6 scope)
2. **Negative test**: Verify all_cores_in_c6 signal during MC6 does not trigger PC6 fabric power-gating flow
