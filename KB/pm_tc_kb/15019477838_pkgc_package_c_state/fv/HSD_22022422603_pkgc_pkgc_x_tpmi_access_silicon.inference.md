# HSD 22022422603: PkgC x TPMI access_silicon

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422603](https://hsdes.intel.com/appstore/article/#/22022422603) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x TPMI |
...
Verify TPMI access does not generate wake event or impact PC6 residency.
...
**Verify TPMI access works without PC6 residency check - always 0**
...
2. **Negative test**: Verify TPMI access works without PC6 residency check - always 0
