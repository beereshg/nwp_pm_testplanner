# HSD 22022422584: PkgC x Probe mode_silicon

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422584](https://hsdes.intel.com/appstore/article/#/22022422584) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x Probe mode |
...
Probe Mode generates PC6 exit. While in probe mode, no PC6 entry allowed.
...
**Verify Probe Mode works without PC6 exit dependency - MC6 exit sufficient**
...
2. **Negative test**: Verify Probe Mode works without PC6 exit dependency - MC6 exit sufficient
