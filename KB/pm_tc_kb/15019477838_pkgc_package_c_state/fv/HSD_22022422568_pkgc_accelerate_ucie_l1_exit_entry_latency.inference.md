# HSD 22022422568: Accelerate UCIE L1 Exit/Entry Latency

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422568](https://hsdes.intel.com/appstore/article/#/22022422568) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x MeshGV |
...
CCB feature: accelerate UCIe L1 exit/entry latency during PC6.
...
**Verify UCIe L1 latency without PC6 coordination - D2D still works**
...
2. **Negative test**: Verify UCIe L1 latency without PC6 coordination - D2D still works
