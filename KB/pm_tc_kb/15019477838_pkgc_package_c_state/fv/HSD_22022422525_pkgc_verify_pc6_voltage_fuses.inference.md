# HSD 22022422525: Verify PC6 voltage fuses

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422525](https://hsdes.intel.com/appstore/article/#/22022422525) |
| **Segment** | FV |
...
Validate PC6 voltage fuse values from manufacturing.
...
**Verify PC6 voltage fuses exist but are not exercised (PC6 disabled)**
...
2. **Negative test**: Verify PC6 voltage fuses exist but are not exercised (PC6 disabled)
