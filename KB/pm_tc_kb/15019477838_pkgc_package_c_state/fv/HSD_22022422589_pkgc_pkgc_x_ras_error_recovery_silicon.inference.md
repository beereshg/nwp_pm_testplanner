# HSD 22022422589: PkgC x RAS error recovery_silicon

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422589](https://hsdes.intel.com/appstore/article/#/22022422589) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x RAS |
...
During RAS error recovery, PKGC entry disabled by RAS IP mechanism.
...
**Verify RAS recovery works without PC6 interaction - block mechanism N/A**
...
2. **Negative test**: Verify RAS recovery works without PC6 interaction - block mechanism N/A
