# HSD 22022422521: Verify PC6 limit fuse value

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422521](https://hsdes.intel.com/appstore/article/#/22022422521) |
| **Segment** | FV |
...
Validate CBB PKG_C_STATE_LIMIT_REQ fuse controls maximum PC state.
...
**Verify CBB PKG_C_STATE_LIMIT_REQ_C_STATE_MAX_LIMIT=0 (PC6 blocked by fuse)**
...
2. **Negative test**: Verify CBB PKG_C_STATE_LIMIT_REQ_C_STATE_MAX_LIMIT=0 (PC6 blocked by fuse)
