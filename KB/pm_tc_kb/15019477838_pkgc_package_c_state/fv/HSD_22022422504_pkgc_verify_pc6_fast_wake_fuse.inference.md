# HSD 22022422504: Verify PC6 Fast_Wake fuse

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422504](https://hsdes.intel.com/appstore/article/#/22022422504) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | Fuse Checkout |
...
Validate PC6 Fast_Wake fuse: pmsrvr_ptpcfsms_gpio_bump_enables_enable_xxpm_fast_wake_n_fuse.
...
**Disposition: Modify (verify fuse=0)**
...
**Verify FUSE_PKG_C_STATE=0. Fast_Wake fuse value N/A when PC6 disabled**
...
1. **Disposition**: Modify (verify fuse=0)
2. **Negative test**: Verify FUSE_PKG_C_STATE=0. Fast_Wake fuse value N/A when PC6 disabled
