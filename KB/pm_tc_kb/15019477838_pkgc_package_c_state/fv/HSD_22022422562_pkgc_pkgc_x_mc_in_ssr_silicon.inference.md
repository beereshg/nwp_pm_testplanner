# HSD 22022422562: PkgC x MC in SSR_silicon

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422562](https://hsdes.intel.com/appstore/article/#/22022422562) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x MC in SSR |
...
Verify memory controller shallow self-refresh during PC6.
...
**Verify MC SSR operates for MC6 without PC6 dependency**
...
2. **Negative test**: Verify MC SSR operates for MC6 without PC6 dependency
