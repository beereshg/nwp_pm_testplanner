# HSD 22022422501: Verify PkgC Control knobs PIV

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422501](https://hsdes.intel.com/appstore/article/#/22022422501) |
| **Segment** | FV |
...
Pre-silicon verification of PkgC control knobs in emulation.
...
**N/A - PIV environment only, not applicable to silicon**
...
1. **Disposition**: Skip (PIV-only)
2. **Negative test**: N/A - PIV environment only, not applicable to silicon
