# HSD 22022422558: System does not enter PC6 after EMON

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422558](https://hsdes.intel.com/appstore/article/#/22022422558) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC Cross PMON |
...
BEAT item from SPR: system fails to enter PC6 after EMON collection.
...
**Verify EMON collection does not affect already-disabled PC6**
...
1. **Disposition**: Skip (BEAT item)
2. **Negative test**: Verify EMON collection does not affect already-disabled PC6
