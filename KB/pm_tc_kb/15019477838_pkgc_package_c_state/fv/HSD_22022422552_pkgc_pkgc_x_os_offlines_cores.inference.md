# HSD 22022422552: PKGC x OS offlines cores

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422552](https://hsdes.intel.com/appstore/article/#/22022422552) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PKGC x OS offlines |
...
Verify PC6 entry achievable when OS offlines cores.
...
**Verify core offlining does not trigger PC6 path - cores go to MC6 max**
...
2. **Negative test**: Verify core offlining does not trigger PC6 path - cores go to MC6 max
