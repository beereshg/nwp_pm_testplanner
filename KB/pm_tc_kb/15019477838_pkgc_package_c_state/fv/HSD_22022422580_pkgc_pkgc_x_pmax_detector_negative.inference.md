# HSD 22022422580: PkgC x PMAX detector Negative

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422580](https://hsdes.intel.com/appstore/article/#/22022422580) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x PMAX |
...
Negative test: ensure PMAX detector is NOT disabled during PC6 non-retention.
...
**Verify PMAX detector operates normally - no PC6 non-ret mode exists**
...
2. **Negative test**: Verify PMAX detector operates normally - no PC6 non-ret mode exists
