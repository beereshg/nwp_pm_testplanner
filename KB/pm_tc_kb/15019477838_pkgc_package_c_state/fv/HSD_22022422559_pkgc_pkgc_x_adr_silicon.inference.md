# HSD 22022422559: PkgC x ADR_silicon

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422559](https://hsdes.intel.com/appstore/article/#/22022422559) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | PkgC x ADR |
...
Verify ADR flow: cores exit to C0 before ADR, Pcode PM unwind during ADR.
...
**Verify ADR flow works without PC6 exit dependency - MC6 exit sufficient**
...
2. **Negative test**: Verify ADR flow works without PC6 exit dependency - MC6 exit sufficient
