# HSD 22022422475: Ensure VccCORE FIVR is turned off

| Field | Value |
|-------|-------|
| **HSD ID** | [22022422475](https://hsdes.intel.com/appstore/article/#/22022422475) |
| **Segment** | FV |
| **Feature** | Package C-States |
| **Sub-Feature** | Voltage Actions |
...
Verify VccCORE FIVR is gated during PC6. Check workpoint registers show FIVR off state.
...
**Verify VccCORE FIVR remains ON during MC6 - no package-level voltage gating**
...
2. **Negative test**: Verify VccCORE FIVR remains ON during MC6 - no package-level voltage gating
