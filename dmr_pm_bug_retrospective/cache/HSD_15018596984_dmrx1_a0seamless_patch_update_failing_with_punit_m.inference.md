# HSD 15018596984: [DMR][X1 A0]Seamless patch update failing with Punit MCA on DMR after activation

## Metadata

| Field | Value |
|-------|-------|
| **HSD ID** | [15018596984](https://hsdes.intel.com/appstore/article-one/#/15018596984) |
| **Status** | rejected.filed_by_mistake |
| **Priority** | 3-medium |
| **Owner** | nbharati |
| **Component** | val.env.tool |
| **Defect Die** | base |
...
**Reasoning**: component='val.env.tool' → TOOL
...
### Tags
FV_CONCURRENCY,Cloned_ToSiliconSighting
...
- **Submitted**: 2025-11-04 06:36:08
- **Closed**: 2025-11-04 06:38:05
